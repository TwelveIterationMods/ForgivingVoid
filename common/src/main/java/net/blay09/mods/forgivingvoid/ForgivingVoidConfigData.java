...
public class ForgivingVoidConfigData {
    ...
    public static ForgivingVoidConfigData getActive() {
        return Balm.getConfig().getActiveConfig(ForgivingVoidConfigData.class);
    }

    public static void initialize() {
        Balm.getConfig().registerConfig(ForgivingVoidConfigData.class);
    }
}
